...
const MealCard = ({
  ...
  return (
    <Card
      className="group max-w-md cursor-pointer overflow-hidden transition-shadow duration-200 hover:shadow-lg"
      tabIndex={0}
      role="button"
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-3 gap-4">
            <div className="bg-muted/30 hover:bg-muted/50 rounded-lg p-3 text-center transition-colors">
              ...
              {showNutritionDetails && (
                <p className="text-muted-foreground mt-1 text-xs">
                  {Math.round(
                    ((meal.macros.protein * 4) / meal.calories) * 100,
                  )}
                  % of calories
                </p>
              )}
            ...
            <div className="bg-muted/30 hover:bg-muted/50 rounded-lg p-3 text-center transition-colors">
              ...
              {showNutritionDetails && (
                <p className="text-muted-foreground mt-1 text-xs">
                  {Math.round(((meal.macros.fat * 9) / meal.calories) * 100)}%
                  of calories
                </p>
              )}
            </div>
            <div className="bg-muted/30 hover:bg-muted/50 rounded-lg p-3 text-center transition-colors">
              ...
              {showNutritionDetails && (
                <p className="text-muted-foreground mt-1 text-xs">
                  {Math.round(((meal.macros.carbs * 4) / meal.calories) * 100)}%
                  of calories
                </p>
              )}
            </div>
