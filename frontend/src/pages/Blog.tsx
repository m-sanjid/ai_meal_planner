  ...
  return (
    <PageLayout>
      <div className="max-w-6xl mx-auto px-4 py-12">
        ...
        >
          <h1 className="text-4xl font-bold mb-4">BefitAI Blog</h1>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {blogPosts.map((post, index) => (
            <motion.article
              ...
              className="bg-card hover:bg-card/80 transition-colors duration-200 border rounded-xl overflow-hidden group"
            >
...
const blogPosts = [
  ...
  },
  {
    ...
    readTime: 7,
    category: "AI & Technology",
    image: "https://images.unsplash.com/photo-1490818387583-1baba5e638af?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=80",
    excerpt:
